...
<nav style="display: flex; flex-direction: column; gap: 5px; margin-top: 10px; padding-top: 20px; border-top: 1px solid #eee;">
  <div>
    <a href="/setting-up-playwright" style="text-decoration: none; color: #0366d6;">Next: Setting up Playwright and why it matters →</a>
  </div>
  <div>
    <a href="/context-engineering" style="text-decoration: none; color: #0366d6;">← Previous: Context engineering, not prompt engineering</a>
  </div>
  <div>
